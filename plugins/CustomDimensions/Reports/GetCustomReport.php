...
class GetCustomReport extends Base
{
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('Recipe(Action Scope)');
        $this->dimension     = null;
        $this->documentation = Piwik::translate('');
        $this->subcategoryId = 'Recipe (Action Scope)';
        $this->metrics = array('recipeid','visitServerHour', 'idSite', 'totalAbandonedCartsItems', 'totalAbandonedCartsRevenue');
        ...
        $this->subcategoryId = 'CustomDimensions_CustomReport';
    }
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        $view->config->addTranslation('recipeid', 'RECIPE ID');
        $view->config->addTranslation('visitServerHour', 'VISITS');
        $view->config->addTranslation('idSite', 'ORDER ID');
        $view->config->addTranslation('totalAbandonedCartsItems', 'TOTAL NUMBERS OF ITEMS IN CART');
        $view->config->addTranslation('totalAbandonedCartsRevenue', 'TOTAL ORDER VALUE');
    ...
    public function getRelatedReports()
    {
        ...
        return  $arr; // eg return array(new XyzReport());
    }
    ...
    {
    $view = new View('@CustomDimensions/getCustomReport');
    $view->myData = array();
